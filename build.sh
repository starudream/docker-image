...
docker tag "${USERNAME}"/"${NAME}":latest docker.pkg.github.com/"${USERNAME}"/"${REPOSITORY}"/"${NAME}":latest
docker push docker.pkg.github.com/"${USERNAME}"/"${REPOSITORY}"/"${NAME}":latest
